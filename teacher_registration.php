...
$query_access  = "INSERT INTO `user_activity`(`user_id`, `user_role`, `accessed_page`, `access_date`, `access_time`) VALUES ('$adminid','$role','teacher registration',now(),now())";
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Teacher Registration Form</h6>
                            <form action="teacher_reg.php" method="POST">
                                <div class="row mb-3">
                                    <label for="inputName" class="col-sm-2 col-form-label">Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="teacher_name" required class="form-control" id="inputName">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="teacher_department" required class="form-control" id="inputDepartment">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPhone" class="col-sm-2 col-form-label">Phone Number</label>
                                    <div class="col-sm-10">
                                        <input type="number" name="teacher_number" required class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                                    <div class="col-sm-10">
                                        <input type="email" name="teacher_email" required class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPassword3" class="col-sm-2 col-form-label">Password</label>
                                    <div class="col-sm-10">
                                        <input type="password" name="teacher_password" required class="form-control" id="inputPassword3">
                                    </div>
                                </div>
                                <fieldset class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="teacher_type"
                                                id="gridHod" value="2" checked>

...
$query_access  = "INSERT INTO `user_activity`(`user_id`, `user_role`, `accessed_page`, `access_date`, `access_time`) VALUES ('$adminid','$role','e learning',now(),now())";
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <?php if($role==2||$role==3){ ?>
                        ...
                        <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-address-book" aria-hidden="true"></i>E-learning</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="e_learning.php" class="dropdown-item active">Upload Books</a>
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="upload_file.php" method="POST" enctype="multipart/form-data">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="title" required class="form-control" id="input_title">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="subject" required class="form-control" id="input_subject">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputPhone" class="col-sm-2 col-form-label">Add File</label>
                                    <div class="col-sm-10">
                                        <input type="file" name="add_file" required class="form-control" id="input_file">
                                    </div>
                                </div>
